<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="Searchstdwithoutlogin.aspx.cs" Inherits="WebApplication2.Searchstdwithoutlogin" %>
                        ...
                        <td class="tbl">
                            <table align="left" class="lbl">
                                ...
                                <tr>
                                    ...
                                    <td class="style43">
                                        <asp:TextBox ID="txtSpass" runat="server" CssClass="txtt" TextMode="Password" placeholder="enter password" MaxLength="8"></asp:TextBox>
                                    </td>
                                    <td class="style42">
                                ...
                                <tr>
                                    ...
                                    <td class="style45">
                                        <asp:TextBox ID="txtSconfPassword" runat="server" CssClass="txtt" 
                                            TextMode="Password" placeholder="enter confo. password" MaxLength="8"></asp:TextBox>
                                    </td>
                                    <td class="style45">
                                ...
                                <tr>
                                    ...
                                    <td class="style38">
                                        <asp:Button ID="Button4" runat="server" Text="Continue" Width="166px" />
                                    </td>
                                    <td class="style39">
                                        <asp:Button ID="Button5" runat="server" Text="Reset" Width="119px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style8">
